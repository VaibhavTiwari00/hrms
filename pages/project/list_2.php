					...
					<div class="row align-items-center">
						...
						<div class="col-auto float-right ml-auto">
							...
							<div class="view-icons">
								<a href="<?= home_path() ?>/project/list" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
								<a href="<?= home_path() ?>/project/list_2" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
						<div class="card">
							<div class="card-body">
								...
								<h4 class="project-title"><a href="<?= home_path() ?>/project/view_project">Office Management</a></h4>
								...
								<div class="project-members m-b-15">
									...
									<ul class="team-members">
										<li>
											<a href="#" data-toggle="tooltip" title="Jeffery Lalor"><img alt="" src="<?= get_assets() ?>img/profiles/avatar-16.jpg"></a>
										</li>
									</ul>
								</div>
								<div class="project-members m-b-15">
									...
									<ul class="team-members">
										<li>
											<a href="#" data-toggle="tooltip" title="John Doe"><img alt="" src="<?= get_assets() ?>img/profiles/avatar-02.jpg"></a>
										</li>
										<li>
											<a href="#" data-toggle="tooltip" title="Richard Miles"><img alt="" src="<?= get_assets() ?>img/profiles/avatar-09.jpg"></a>
										</li>
										<li>
											<a href="#" data-toggle="tooltip" title="John Smith"><img alt="" src="<?= get_assets() ?>img/profiles/avatar-10.jpg"></a>
										</li>
										<li>
											<a href="#" data-toggle="tooltip" title="Mike Litorus"><img alt="" src="<?= get_assets() ?>img/profiles/avatar-05.jpg"></a>
										</li>
										<li class="dropdown avatar-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<div class="avatar-group">
													...
													<a class="avatar avatar-xs" href="#">
														<img alt="" src="<?= get_assets() ?>img/profiles/avatar-11.jpg">
													</a>
													<a class="avatar avatar-xs" href="#">
														<img alt="" src="<?= get_assets() ?>img/profiles/avatar-12.jpg">
													</a>
													<a class="avatar avatar-xs" href="#">
														<img alt="" src="<?= get_assets() ?>img/profiles/avatar-13.jpg">
													</a>
													<a class="avatar avatar-xs" href="#">
														<img alt="" src="<?= get_assets() ?>img/profiles/avatar-01.jpg">
													</a>
													<a class="avatar avatar-xs" href="#">
					...
					<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
						<div class="card">
							<div class="card-body">
								...
								<h4 class="project-title"><a href="<?= home_path() ?>/project/view_project">Project Management</a></h4>
								<small class="block text-ellipsis m-b-15">
					...
					<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
						<div class="card">
							<div class="card-body">
								...
								<h4 class="project-title"><a href="<?= home_path() ?>/project/view_project">Video Calling App</a></h4>
								<small class="block text-ellipsis m-b-15">
					...
					<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
						<div class="card">
							<div class="card-body">
								...
								<h4 class="project-title"><a href="<?= home_path() ?>/project/view_project">Hospital Administration</a></h4>
								<small class="block text-ellipsis m-b-15">
