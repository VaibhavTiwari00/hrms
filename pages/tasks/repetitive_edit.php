...
<head>
    ...
    <title>Repetitive Tasks Edit </title>
...
<body>
                    ...
                    <form class="container" id="editTask">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="task_name" type="text" value="<?= $results[0]['rtm_title'] ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="task_priority">
                                        <?php if ($results[0]['rtm_priority'] == 1) {
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select" name="task_assign_to" id="task_assign_to">
                                        ...
                                        foreach ($all_dept_user_data as $row) {
                                            if ($results[0]['rtm_assign_to'] == $row['user_unique_id']) {
                                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="task_type" type="text" value="Repetitive">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 task_frequency">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="task_frequency" id="task_frequency">
                                        <?php if ($results[0]['rtm_repetitive_type'] == 1) {
                                            echo '  <option value="1" selected>Daily</option>
                                        <option value="2">Weekly</option>
                                        <option value="3">Monthly</option>
                                        <option value="4">Type Manually</option>>';
                                        } else if ($results[0]['rtm_repetitive_type'] == 2) {
                                            echo '  <option value="1">Daily</option>
                                        ...
                                        <option value="2">Weekly</option>
                                        <option value="3" >Monthly</option>
                                        <option value="4" selected>Type Manually</option>';
                                        } ?>
                        ...
                        <div class="row task_frequency_date">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="task_frequency_date" name="task_frequency_date" type="number" value="<?= $results[0]['rtm_frequency_repeat_days']  ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="task_start_date" id="start_date" class="form-control" type="datetime-local" value="<?= $results[0]['rtm_start_date'] ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>End Date<span class="text-danger"></span></label>
                                    <input name="task_end_date" id="end_date" class="form-control" type="datetime-local" value="<?= $results[0]['rtm_end_date'] ?>">

                                    <input type="text" name="task_id" value="<?= $results[0]['rtm_id'] ?>" hidden>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="files-list">
                                    <?php $img_arr = json_decode($results[0]['rtm_image']);
    ...
    <script>
        ...
        $('#editTask').submit(function(event) {
            ...
            $.ajax({
                url: '../action/tasks.php?do=repetitive_edit_task',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if (responseData.status == true) {
                        alert(responseData.msg);
                        window.location.href = "<?= home_path() ?>/tasks/daily_list";
                    } else {
                        alert(responseData.msg);
