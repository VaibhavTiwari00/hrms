...
// Assuming $datetime1 and $datetime2 hold your datetime values in the format 'Y-m-d H:i:s'
// Assuming $datetime1 and $datetime2 hold your datetime values in the format 'Y-m-d H:i:s'
// function gget_daily_task_time_acc_date_or_task(PDO $DB, $date, $user = null, $task_id)
// {
...
// echo gget_daily_task_time_acc_date_or_task($DB, $date, $user, 724);
